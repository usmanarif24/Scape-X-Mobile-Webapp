...
(function (t, q) { "object" === typeof exports && "object" === typeof module ? module.exports = q() : "function" === typeof define && define.amd ? define(q) : "object" === typeof exports ? exports = q() : t.Paho = q(); })(this, function () {
    return function (t) {
        function q(a, b, c) { b[c++] = a >> 8; b[c++] = a % 256; return c; }
        function r(a, b, c, k) { k = q(b, c, k); E(a, c, k); return k + b; }
        function n(a) { for (var b = 0, c = 0; c < a.length; c++) {
        ...
        function E(a, b, c) {
            for (var k = 0; k < a.length; k++) {
                ...
                if (55296 <= e && 56319 >= e) {
                    ...
                    if (isNaN(g))
                        throw Error(f(h.MALFORMED_UNICODE, [e, g]));
                ...
                if (!(128 > e)) {
                    ...
                    if (224 > e)
                        ...
                        if (240 > e)
                            ...
                            var l = a[g++] - 128;
                            if (0 > l)
                                throw Error(f(h.MALFORMED_UTF, [e.toString(16), m.toString(16), d.toString(16), l.toString(16)]));
                            if (248 > e)
                                e = 262144 * (e - 240) + 4096 * m + 64 * d + l;
                            else
                                throw Error(f(h.MALFORMED_UTF, [e.toString(16), m.toString(16), d.toString(16), l.toString(16)]));
                        }
                    }
        ...
        var s = t.localStorage || function () { var a = {}; return { setItem: function (b, c) { a[b] = c; }, getItem: function (b) { return a[b]; }, removeItem: function (b) { delete a[b]; } }; }(), A = function (a, b) { for (var c in a)
            if (a.hasOwnProperty(c))
                if (b.hasOwnProperty(c)) {
                    ...
                    for (var k in b)
                        b.hasOwnProperty(k) && (c = c + " " + k);
                    throw Error(c);
                } }, u = function (a, b) { return function () { return a.apply(b, arguments); }; }, h = { OK: { code: 0, text: "AMQJSC0000I OK." },
            ...
            for (var k, e, g = 0; g < b.length; g++)
                if (k = "{" + g + "}", e = c.indexOf(k), 0 < e)
                    var h = c.substring(0, e), c = c.substring(e + k.length), c = h + b[g] + c; return c; }, B = [0, 6, 77, 81, 73, 115, 100, 112, 3], C = [0, 4, 77, 81, 84, 84, 4], p = function (a, b) { this.type = a; for (var c in b)
        ...
        p.prototype.encode = function () {
            ...
            switch (this.type) {
                ...
                case 3:
                    ...
                    var k = n(this.payloadMessage.destinationName), h = this.payloadMessage.payloadBytes, b = b + (k + 2) + h.byteLength;
            ...
            d.set(g, 1);
            if (3 == this.type)
                f = r(this.payloadMessage.destinationName, k, d, f);
            else if (1 == this.type) {
                switch (this.mqttVersion) {
                    case 3:
                        d.set(B, f);
            ...
            switch (this.type) {
                ...
                case 8:
                    for (g = 0; g < this.topics.length; g++)
                        f = r(this.topics[g], c[g], d, f), d[f++] = this.requestedQos[g];
                    break;
                case 10: for (g = 0; g < this.topics.length; g++)
                    f = r(this.topics[g], c[g], d, f);
            }
            return b;
        };
        var G = function (a, b) {
            ...
            this.isReset = !1;
            var c = (new p(12)).encode(), k = function (a) { return function () { return e.apply(a); }; }, e = function () { this.isReset ? (this.isReset = !1, this._client._trace("Pinger.doPing", "send PINGREQ"), this._client.socket.send(c), this.timeout = setTimeout(k(this), this._keepAliveInterval)) : (this._client._trace("Pinger.doPing", "Timed out"), this._client._disconnected(h.PING_TIMEOUT.code, f(h.PING_TIMEOUT))); };
            this.reset = function () {
                this.isReset = !0;
            ...
            if (!("WebSocket" in t && null !== t.WebSocket))
                throw Error(f(h.UNSUPPORTED, ["WebSocket"]));
            if (!("ArrayBuffer" in t && null !== t.ArrayBuffer))
                throw Error(f(h.UNSUPPORTED, ["ArrayBuffer"]));
            this._trace("Paho.Client", a, b, c, d, e);
            this.host = b;
            this.port = c;
            this.path = d;
            this.uri = a;
            ...
            this._sequence = 0;
            for (var g in s)
                0 !== g.indexOf("Sent:" + this._localKey) && 0 !== g.indexOf("Received:" + this._localKey) || this.restore(g);
        };
        ...
        d.prototype.subscribe = function (a, b) {
            ...
            c.requestedQos = [];
            for (var d = 0; d < c.topics.length; d++)
                c.requestedQos[d] = b.qos;
            b.onSuccess && (c.onSuccess = function (a) { b.onSuccess({ invocationContext: b.invocationContext, grantedQos: a }); });
            b.onFailure && (c.onFailure = function (a) { b.onFailure({ invocationContext: b.invocationContext, errorCode: a, errorMessage: f(a) }); });
            b.timeout && (c.timeOut = new v(this, b.timeout, b.onFailure, [{ invocationContext: b.invocationContext, errorCode: h.SUBSCRIBE_TIMEOUT.code, errorMessage: f(h.SUBSCRIBE_TIMEOUT) }]));
            this._requires_ack(c);
            this._schedule_message(c);
        };
        d.prototype.unsubscribe =
            function (a, b) { this._trace("Client.unsubscribe", a, b); if (!this.connected)
                throw Error(f(h.INVALID_STATE, ["not connected"])); var c = new p(10); c.topics = a.constructor === Array ? a : [a]; b.onSuccess && (c.callback = function () { b.onSuccess({ invocationContext: b.invocationContext }); }); b.timeout && (c.timeOut = new v(this, b.timeout, b.onFailure, [{ invocationContext: b.invocationContext, errorCode: h.UNSUBSCRIBE_TIMEOUT.code, errorMessage: f(h.UNSUBSCRIBE_TIMEOUT) }])); this._requires_ack(c); this._schedule_message(c); };
        d.prototype.send =
            function (a) {
                ...
                b.payloadMessage = a;
                if (this.connected)
                    0 < a.qos ? this._requires_ack(b) : this.onMessageDelivered && (this._notify_msg_sent[b] = this.onMessageDelivered(b.payloadMessage)), this._schedule_message(b);
        ...
        d.prototype.disconnect = function () { this._trace("Client.disconnect"); this._reconnecting && (this._reconnectTimeout.cancel(), this._reconnectTimeout = null, this._reconnecting = !1); if (!this.socket)
            throw Error(f(h.INVALID_STATE, ["not connecting or connected"])); var a = new p(14); this._notify_msg_sent[a] = u(this._disconnected, this); this._schedule_message(a); };
        ...
        d.prototype.startTrace = function () { null === this._traceBuffer && (this._traceBuffer = []); this._trace("Client.startTrace", new Date, "1.1.0-2018-11-22T11:35:36Z"); };
        d.prototype.stopTrace =
            function () { delete this._traceBuffer; };
        d.prototype._doConnect = function (a) {
            ...
            this.socket.onclose = u(this._on_socket_close, this);
        ...
        d.prototype._schedule_message = function (a) { this._msg_queue.unshift(a); this.connected && this._process_queue(); };
        d.prototype.store = function (a, b) {
            ...
            switch (b.type) {
                case 3:
                    ...
                    break;
                default: throw Error(f(h.INVALID_STORED_DATA, [a + this._localKey + b.messageIdentifier, c]));
            }
            ...
            switch (c.type) {
                case 3:
                    for (var b = c.payloadMessage.payloadHex, e = new ArrayBuffer(b.length / 2), e = new Uint8Array(e), g = 0; 2 <= b.length;) {
                        var m = parseInt(b.substring(0, 2), 16), b = b.substring(2, b.length);
                        e[g++] = m;
                    }
                    b = new w(e);
        ...
        d.prototype._process_queue = function () { for (var a = null; a = this._msg_queue.pop();)
        ...
        d.prototype._on_socket_open = function () { var a = new p(1, this.connectOptions); a.clientId = this.clientId; this._socket_send(a); };
        d.prototype._on_socket_message = function (a) { this._trace("Client._on_socket_message", a.data); a = this._deframeMessages(a.data); for (var b = 0; b < a.length; b += 1)
                        ...
                        if (x > e.length)
                            ...
                            switch (l) {
                                case 2:
                                    ...
                                    break;
                                case 3:
                                    var m = z >> 1 & 3, s = 256 * e[g] + e[g + 1], g = g + 2, t = F(e, g, s), g = g + s;
                                ...
                                case 11:
                                    ...
                                    break;
                                case 9: y.messageIdentifier = 256 * e[g] + e[g + 1], g += 2, y.returnCode = e.subarray(g, x);
                            }
                            d = [y, x];
                        }
                    }
                ...
                switch (a.type) {
                    case 2:
                        ...
                        if (0 < this._buffered_msg_queue.length)
                            for (e =
                                null; e = this._buffered_msg_queue.pop();)
                                a.push(e), this.onMessageDelivered && (this._notify_msg_sent[e] = this.onMessageDelivered(e.payloadMessage));
                        a = a.sort(function (a, b) { return a.sequence - b.sequence; });
                        e = 0;
                    ...
                    case 4:
                        if (c = this._sentMessages[a.messageIdentifier])
                            if (delete this._sentMessages[a.messageIdentifier], s.removeItem("Sent:" + this._localKey + a.messageIdentifier), this.onMessageDelivered)
                                this.onMessageDelivered(c.payloadMessage);
                        break;
                    case 5:
                        if (c = this._sentMessages[a.messageIdentifier])
                            c.pubRecReceived = !0, m = new p(6, { messageIdentifier: a.messageIdentifier }),
                    ...
                    case 14:
                        ...
                        break;
                    default: this._disconnected(h.INVALID_MQTT_MESSAGE_TYPE.code, f(h.INVALID_MQTT_MESSAGE_TYPE, [a.type]));
                }
            }
            catch (l) {
        ...
        d.prototype._on_socket_error = function (a) { this._reconnecting || this._disconnected(h.SOCKET_ERROR.code, f(h.SOCKET_ERROR, [a.data])); };
        d.prototype._on_socket_close = function () {
            this._reconnecting ||
                this._disconnected(h.SOCKET_CLOSE.code, f(h.SOCKET_CLOSE));
        };
        d.prototype._socket_send = function (a) { if (1 == a.type) {
            var b = this._traceMask(a, "password");
            this._trace("Client._socket_send", b);
        }
        else
            this._trace("Client._socket_send", a); this.socket.send(a.encode()); this.sendPinger.reset(); };
        d.prototype._receivePublish = function (a) {
            switch (a.payloadMessage.qos) {
                ...
                case 2:
                    ...
                    break;
                default: throw Error("Invaild qos\x3d" + a.payloadMessage.qos);
            }
        };
        d.prototype._receiveMessage = function (a) { if (this.onMessageArrived)
            this.onMessageArrived(a.payloadMessage); };
        d.prototype._connected = function (a, b) { if (this.onConnected)
            this.onConnected(a, b); };
        ...
        d.prototype._disconnected = function (a, b) {
            ...
            if (void 0 !== a && this._reconnecting)
                this._reconnectTimeout = new v(this, this._reconnectInterval, this._reconnect);
                ...
                if (this.onConnectionLost)
                    this.onConnectionLost({ errorCode: a, errorMessage: b, reconnect: this.connectOptions.reconnect, uri: this._wsuri });
                ...
                this._trace("Failed to connect V4, dropping back to V3"), this.connectOptions.mqttVersion = 3, this.connectOptions.uris ? (this.hostIndex = 0, this._doConnect(this.connectOptions.uris[0])) :
        ...
        d.prototype._trace = function () {
            if (this.traceFunction) {
                ...
                for (b in a)
                    "undefined" !== typeof a[b] && a.splice(b, 1, JSON.stringify(a[b]));
                b = a.join("");
                this.traceFunction({ severity: "Debug", message: b });
            }
            if (null !== this._traceBuffer)
                for (b = 0, a = arguments.length; b < a; b++)
        ...
        d.prototype._traceMask = function (a, b) { var c = {}, d; for (d in a)
            a.hasOwnProperty(d) && (c[d] = d == b ? "******" : a[d]); return c; };
        var w = function (a) {
            var b;
            if ("string" === typeof a || a instanceof ArrayBuffer || ArrayBuffer.isView(a) && !(a instanceof DataView))
                b = a;
            else
                throw f(h.INVALID_ARGUMENT, [a,
                    "newPayload"]);
            var c, d = 0, e = !1, g = !1;
            Object.defineProperties(this, { payloadString: { enumerable: !0, get: function () { return "string" === typeof b ? b : F(b, 0, b.length); } }, payloadBytes: { enumerable: !0, get: function () { if ("string" === typeof b) {
                        var a = new ArrayBuffer(n(b)), a = new Uint8Array(a);
                        E(b, a, 0);
                        return a;
                    } return b; } }, destinationName: { enumerable: !0, get: function () { return c; }, set: function (a) { if ("string" === typeof a)
                        c = a;
                    else
                        throw Error(f(h.INVALID_ARGUMENT, [a, "newDestinationName"])); } }, qos: { enumerable: !0, get: function () { return d; },
                    set: function (a) { if (0 === a || 1 === a || 2 === a)
                        d = a;
                    else
                        throw Error("Invalid argument:" + a); } }, retained: { enumerable: !0, get: function () { return e; }, set: function (a) { if ("boolean" === typeof a)
                        e = a;
                    else
                        throw Error(f(h.INVALID_ARGUMENT, [a, "newRetained"])); } }, topic: { enumerable: !0, get: function () { return c; }, set: function (a) { c = a; } }, duplicate: { enumerable: !0, get: function () { return g; }, set: function (a) { g = a; } } });
        };
        return { Client: function (a, b, c, k) {
                var e;
                if ("string" !== typeof a)
                ...
                if (2 == arguments.length) {
                    ...
                    var g = e.match(/^(wss?):\/\/((\[(.+)\])|([^\/]+?))(:(\d+))?(\/.*)$/);
                    if (g)
                        a = g[4] || g[2], b = parseInt(g[7]), c = g[8];
                    else
                        throw Error(f(h.INVALID_ARGUMENT, [a, "host"]));
                }
                else {
                ...
                Object.defineProperties(this, { host: { get: function () { return a; }, set: function () { throw Error(f(h.UNSUPPORTED_OPERATION)); } }, port: { get: function () { return b; }, set: function () { throw Error(f(h.UNSUPPORTED_OPERATION)); } }, path: { get: function () { return c; }, set: function () { throw Error(f(h.UNSUPPORTED_OPERATION)); } }, uri: { get: function () { return e; }, set: function () {
                            throw Error(f(h.UNSUPPORTED_OPERATION));
                        } }, clientId: { get: function () { return l.clientId; }, set: function () { throw Error(f(h.UNSUPPORTED_OPERATION)); } }, onConnected: { get: function () { return l.onConnected; }, set: function (a) { if ("function" === typeof a)
                            l.onConnected = a;
                        else
                            throw Error(f(h.INVALID_TYPE, [typeof a, "onConnected"])); } }, disconnectedPublishing: { get: function () { return l.disconnectedPublishing; }, set: function (a) { l.disconnectedPublishing = a; } }, disconnectedBufferSize: { get: function () { return l.disconnectedBufferSize; }, set: function (a) {
                            l.disconnectedBufferSize =
                                a;
                        } }, onConnectionLost: { get: function () { return l.onConnectionLost; }, set: function (a) { if ("function" === typeof a)
                            l.onConnectionLost = a;
                        else
                            throw Error(f(h.INVALID_TYPE, [typeof a, "onConnectionLost"])); } }, onMessageDelivered: { get: function () { return l.onMessageDelivered; }, set: function (a) { if ("function" === typeof a)
                            l.onMessageDelivered = a;
                        else
                            throw Error(f(h.INVALID_TYPE, [typeof a, "onMessageDelivered"])); } }, onMessageArrived: { get: function () { return l.onMessageArrived; }, set: function (a) {
                            if ("function" === typeof a)
                                l.onMessageArrived =
                                    a;
                            else
                                throw Error(f(h.INVALID_TYPE, [typeof a, "onMessageArrived"]));
                        } }, trace: { get: function () { return l.traceFunction; }, set: function (a) { if ("function" === typeof a)
                            l.traceFunction = a;
                        else
                            throw Error(f(h.INVALID_TYPE, [typeof a, "onTrace"])); } } });
                this.connect = function (a) {
                    a = a || {};
                    A(a, { timeout: "number", userName: "string", password: "string", willMessage: "object", keepAliveInterval: "number", cleanSession: "boolean", useSSL: "boolean", invocationContext: "object", onSuccess: "function", onFailure: "function", hosts: "object",
                    ...
                    if (a.willMessage) {
                        ...
                        if ("undefined" === typeof a.willMessage.destinationName)
                            throw Error(f(h.INVALID_TYPE, [typeof a.willMessage.destinationName, "connectOptions.willMessage.destinationName"]));
                    }
                        ...
                        if (b)
                            ...
                            for (d = 0; d < a.hosts.length; d++) {
                                if ("number" !== typeof a.ports[d] || 0 > a.ports[d])
                                    throw Error(f(h.INVALID_TYPE, [typeof a.ports[d], "connectOptions.ports[" + d + "]"]));
                ...
                this.subscribe = function (a, b) { if ("string" !== typeof a && a.constructor !== Array)
                    throw Error("Invalid argument:" + a); b = b || {}; A(b, { qos: "number", invocationContext: "object", onSuccess: "function", onFailure: "function", timeout: "number" }); if (b.timeout && !b.onFailure)
                    throw Error("subscribeOptions.timeout specified with no onFailure callback."); if ("undefined" !== typeof b.qos && 0 !== b.qos && 1 !== b.qos && 2 !== b.qos)
                    throw Error(f(h.INVALID_ARGUMENT, [b.qos, "subscribeOptions.qos"])); l.subscribe(a, b); };
                this.unsubscribe = function (a, b) { if ("string" !== typeof a && a.constructor !== Array)
                    throw Error("Invalid argument:" + a); b = b || {}; A(b, { invocationContext: "object", onSuccess: "function", onFailure: "function", timeout: "number" }); if (b.timeout && !b.onFailure)
                    throw Error("unsubscribeOptions.timeout specified with no onFailure callback."); l.unsubscribe(a, b); };
                this.send = function (a, b, c, d) {
                    var e;
                    if (0 === arguments.length)
                        throw Error("Invalid argument.length");
                    if (1 == arguments.length) {
                        if (!(a instanceof w) && "string" !== typeof a)
                        ...
                        e = new w(b), e.destinationName = a, 3 <= arguments.length && (e.qos = c), 4 <= arguments.length && (e.retained = d);
                    l.send(e);
                };
